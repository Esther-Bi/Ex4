...
class MyTestCase(unittest.TestCase):
    ...
    def test_init(self):
        self.assertEqual(pokemons.pokemon_list[0].value, 7.0)  # add assertion here
        self.assertEqual(pokemons.pokemon_list[1].x, 3.0)
        self.assertEqual(pokemons.pokemon_list[1].type, -1)
