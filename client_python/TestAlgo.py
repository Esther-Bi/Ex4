...
class MyTestCase(unittest.TestCase):
    ...
    str_pokemon = "{\"Pokemons\":[{\"Pokemon\":{\"value\":7.0,\"type\":1,\"pos\":\"35.197656770719604,32.10191878639921,0.0\"}},{\"Pokemon\":{\"value\":6.0,\"type\":-1,\"pos\":\"3.0,32.10191878639921,0.0\"}},{\"Pokemon\":{\"value\":5.0,\"type\":-1,\"pos\":\"35.197656770719604,32.10191878639921,0.0\"}}]}"
    ...
    pokemons = Pokemons(str_pokemon, graph)
    client = Client()
    ...
    def test_algo(self):
        gui.algo(agents, pokemons, client)
        self.assertEqual(agents[0].node_tasks, 2)  # add assertion here
